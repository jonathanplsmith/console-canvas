...
int main(void) {
    ...
    canvas_t *cons = newCanvas(21, 48);

    setFg(cons, GREEN);
    setBg(cons, BLACK);
    placeTextHor(cons, "You can write colourful text to the console", 2, 6);
    refreshConsole(cons);
    sleep(1);
    setFg(cons, WHITE);
    setBg(cons, RED);
    placeTextVert(cons, "Vertically too!", 4, 10);
    refreshConsole(cons);
    sleep(3);
    ...
    clearCanvas(cons);
    placeTextHor(cons, "You can draw characters to the console", 2, 10);
    refreshConsole(cons);
    setFg(cons, BYELLOW);
    sleep(1);
    ...
    setFg(cons, RESET_COLOUR);
    clearCanvas(cons);
    placeTextHor(cons, "Or you could draw some lines", 2, 10);
    refreshConsole(cons);
    sleep(1);
